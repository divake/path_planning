...
sys.path.append('../..')  # Add path to continuous_planner
sys.path.append('../../../../CurvesGenerator')  # Add path to CurvesGenerator
...
class StandardCPPlanner:
    ...
    def __init__(self, config_path: str = "../../config/standard_cp_config.yaml"):
        ...
        self.noise_model = NoiseModel(config_path)
        self.nonconformity_calc = NonconformityScorer(config_path)
